// =====================================================
// 义教化学课标图谱 - Neo4j导入脚本
// 生成时间: 2026-01-15T16:04:28.587503
// =====================================================
...
MERGE (n:CoreLiteracy {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
SET n += {type: "CoreLiteracy", title: "化学观念", description: "化学观念是人类探索物质的组成与结构、性质与应用、化学反应及其规律所形成的基本观念，是化学概念、原理和规律的提炼与升华，是认识物质及其变化，以及解决实际问题的基础。\n\n化学观念主要包括：物质是由元素组成的；物质具有多样性，可以分为不同的类别；物质是由分子、原子等构成的，物质结构决定性质，物质性质决定用途；化学变化有新物质生成，其本质是原子的重新组合，且伴随着能量变化，并遵循一定的规律；在一定条件下通过化学反应可以实现物质转化；等等。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"};

MERGE (n:CoreLiteracy {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l2"})
SET n += {type: "CoreLiteracy", title: "科学思维", description: "科学思维是在化学学习中基于事实与逻辑进行独立思考和判断，对不同信息、观点和结论进行质疑与批判，提出创造性见解的能力；是从化学视角研究物质及其变化规律的思路与方法；是从宏观、微观、符号相结合的视角探究物质及其变化规律的认识方式。\n\n科学思维主要包括：在解决化学问题中所运用的比较、分类、分析、综合、归纳等科学方法，基于实验事实进行证据推理、建构模型并推测物质及其变化的思维能力，在解决与化学相关的真实问题中形成的质疑能力、批判能力和创新意识。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l2"};

MERGE (n:CoreLiteracy {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l3"})
SET n += {type: "CoreLiteracy", title: "科学探究与实践", description: "科学探究与实践是指经历化学课程中的实验探究，基于学科和跨学科实践活动形成的学习能力；是综合运用化学等学科的知识和方法，通过一定的技术手段，在解决真实情境问题和完成综合实践活动中展现的能力与品格。\n\n科学探究与实践主要包括：以实验为主的科学探究能力，通过网络查询等技术手段获取和加工信息的自主学习能力，运用简单的技术与工程方法设计、制作与使用相关模型和作品的能力，参与社会调查实践、提出解决实际问题初步方案的能力，与他人分工协作、沟通交流、合作问题解决的能力等。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l3"};

MERGE (n:CoreLiteracy {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l4"})
SET n += {type: "CoreLiteracy", title: "科学态度与责任", description: "科学态度与责任是指通过化学课程的学习，在理解科学、技术、社会、环境相互关系的基础上，逐步形成的对化学促进社会可持续发展的正确认识，以及所表现的责任担当。\n\n科学态度与责任主要包括：发展对物质世界的好奇心、想象力和探究欲，保持对化学学习和科学探究的浓厚兴趣；对化学学科促进人类文明和社会可持续发展的重要价值具有积极的认识；具有严谨求实的科学态度，敢于提出并坚持自己的见解、勇于修正或放弃错误观点、反对伪科学的科学精神；遵守科学伦理和法律法规，具有运用化学知识对生活及社会实际问题作出判断和决策的意识；以资源的再生和合理使用、生态和环境的绿色发展为重点，增强学生的资源、生态、环境等方面的国家安全意识；热爱祖国，增强为实现中华民族伟大复兴和推动社会进步而勤奋学习的责任感。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l4"};
...
MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l1"})
SET n += {type: "CoreKnowledge", title: "科学探究的能力", description: "知道科学探究是收集证据和作出解释，进行发现、创造与应用的科学实践活动，也是获取科学知识、理解科学本质、认识客观世界的重要途径。\n了解科学探究过程包括提出问题、形成假设、设计并实施实验或调查方案、获取证据、分析解释数据、形成结论及建构模型、反思评价及表达交流等要素。\n经历科学探究的一般过程，认识从问题和假设出发确定探究目标、依据探究目标设计并实施实验方案、通过观察和实验等方法获取证据、基于证据进行分析推理及形成结论等对于科学探究的意义，体会合作与交流在科学探究中的重要作用。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"实验探究\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l1", CJ_knowledgeUnit: "实验探究"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l2"})
SET n += {type: "CoreKnowledge", title: "基本的化学实验技能", description: "知道化学实验是进行科学探究的重要方式，具备基本的化学实验技能是学习化学和进行探究活动的基础和保证。\n\n对于化学实验技能，应达到如下基本要求。\n\n（1）熟悉化学实验室安全警示标志，学会正确使用安全防护设施，学习妥善应对实验安全问题的必要措施。\n(2) 学会试剂的取用、简单仪器的使用及连接、加热等实验基本操作。\n(3) 初步学会在教师指导下根据实验需要选择实验试剂和仪器,并能安全操作。\n(4) 初步学会配制一定溶质质量分数的溶液。\n(5) 学会用酸碱指示剂、 pH试纸检验溶液的酸碱性。  \n(6) 初步学会根据某些性质检验和区分一些常见的物质。  \n(7) 初步学习使用过滤、蒸发的方法对混合物进行分离。\n(8) 初步学习运用简单的装置和方法制取某些气体。  \n(9) 初步学会观察实验现象，并如实记录、处理实验数据，撰写实验报告等技能。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"实验探究\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l2", CJ_knowledgeUnit: "实验探究"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l3"})
SET n += {type: "CoreKnowledge", title: "空气、氧气、二氧化碳", description: "了解空气的主要成分；通过实验探究认识氧气、二氧化碳的主要性质，认识物质的性质与用途的关系；初步学习氧气和二氧化碳的实验室制法，归纳实验室制取气体的一般思路与方法；以自然界中的氧循环和碳循环为例，认识物质在自然界中可以相互转化及其对维持人类生活与生态平衡的意义。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"常见的物质\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l3", CJ_knowledgeUnit: "常见的物质"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l4"})
SET n += {type: "CoreKnowledge", title: "水和溶液", description: "认识水的组成，知道水是一种重要的溶剂，了解吸附、沉降、过滤和蒸馏是净化水的常用方法。\n\n认识溶解和结晶现象；知道溶液是由溶质和溶剂组成的，具有均一性和稳定性；知道绝大多数物质在溶剂中的溶解是有限度的，了解饱和溶液和溶解度的含义。\n\n知道溶质质量分数可以表示浓度，认识溶质质量分数的含义，学习计算溶质质量分数和配制一定溶质质量分数的溶液的基本方法，初步感受定量研究的意义；体会溶液在生产生活中的应用价值。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"常见的物质\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l4", CJ_knowledgeUnit: "常见的物质"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l5"})
SET n += {type: "CoreKnowledge", title: "金属与金属矿物", description: "知道大多数金属在自然界中是以金属矿物形式存在的，体会化学方法在金属冶炼中的重要性；知道金属具有一些共同的物理性质，通过实验探究等活动认识常见金属的主要化学性质及金属活动性顺序。\n\n知道在金属中加入其他元素形成合金可以改变金属材料的性能；了解金属、金属材料在生产生活和社会发展中的重要作用；以铁生锈为例，了解防止金属腐蚀的常用方法；了解废弃金属对环境的影响及金属回收再利用的价值。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"常见的物质\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l5", CJ_knowledgeUnit: "常见的物质"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l6"})
SET n += {type: "CoreKnowledge", title: "常见的酸、碱、盐", description: "以盐酸、硫酸、氢氧化钠和氢氧化钙为例，通过实验探究认识酸、碱的主要性质和用途；了解检验溶液酸碱性的基本方法，知道酸碱性对人体健康和农作物生长的影响；了解食盐、纯碱、小苏打和碳酸钙等盐在日常生活中的应用；知道一些常用化肥及其在农业生产中的作用。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"常见的物质\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l6", CJ_knowledgeUnit: "常见的物质"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l7"})
SET n += {type: "CoreKnowledge", title: "元素", description: "认识物质是由元素组成的，知道质子数相同的一类原子属于同种元素，了解在化学反应中元素的种类是不变的，初步认识元素周期表。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"元素、分子、原子与物质\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l7", CJ_knowledgeUnit: "元素、分子、原子与物质"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l8"})
SET n += {type: "CoreKnowledge", title: "分子、原子", description: "知道物质是由分子、原子等微观粒子构成的；认识原子是由原子核和核外电子构成的；知道原子可以结合成分子，也可以转变为离子。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"元素、分子、原子与物质\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l8", CJ_knowledgeUnit: "元素、分子、原子与物质"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l9"})
SET n += {type: "CoreKnowledge", title: "物质组成的表示", description: "知道可以用符号表示物质的组成，认识表示分子、原子、离子的符号，知道常见元素的化合价，学习用化学式表示常见物质组成的方法，认识相对原子质量、相对分子质量的含义及应用。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"元素、分子、原子与物质\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l9", CJ_knowledgeUnit: "元素、分子、原子与物质"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l10"})
SET n += {type: "CoreKnowledge", title: "化学变化的特征及化学反应的基本类型", description: "认识化学变化是产生新物质的过程，知道化学变化常伴随生成沉淀、产生气体、发生颜色变化、发光，以及吸热或放热等现象。\n\n理解化学反应的本质是原子的重新组合，化学反应前后，原子的种类和数量不变，分子的种类发生改变；认识常见的化合反应、分解反应、置换反应和复分解反应及简单应用。\n\n了解化学反应需要一定的条件，知道催化剂对化学反应的重要作用；通过实验探究认识燃烧的条件，理解燃烧和灭火的原理及其在生活中的应用，初步体会调控化学反应的重要意义。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"化学反应及质量守恒定律\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l10", CJ_knowledgeUnit: "化学反应及质量守恒定律"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l11"})
SET n += {type: "CoreKnowledge", title: "化学反应的定量关系与质量守恒定律", description: "认识化学反应中的各物质间存在定量关系，化学反应遵守质量守恒定律；理解质量守恒定律的微观本质；知道化学方程式可以表示化学反应，了解化学方程式的含义和书写规则。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"化学反应及质量守恒定律\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l11", CJ_knowledgeUnit: "化学反应及质量守恒定律"};

MERGE (n:CoreKnowledge {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l12"})
SET n += {type: "CoreKnowledge", title: "化学与资源、能源、材料、环境、健康", description: "结合实例，从物质及其变化的视角，认识资源的综合利用与新能源的开发、材料的科学利用与新材料的研发，理解化学与生态环境保护、医药研制及营养健康的关系；了解酒精、天然气、有机高分子材料等在社会生活中的应用；知道资源开发、能源利用和材料使用可能会对环境产生影响，树立环保意识。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{\"knowledgeUnit\": \"化学与资源、能源、材料、环境、健康\"}", identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l12", CJ_knowledgeUnit: "化学与资源、能源、材料、环境、健康"};

MERGE (n:CourseTarget {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
SET n += {type: "CourseTarget", title: "形成化学观念，解决实际问题", description: "初步认识物质的多样性，能对物质及其变化进行分类；能从元素、原子、分子等视角初步分析物质的组成及变化，认识“在一定条件下通过化学反应可以实现物质转化”的重要性；初步学会从定性和定量的视角研究物质的组成及变化，认识质量守恒定律对资源利用和物质转化的重要意义；能通过实例认识物质的性质与应用的关系，形成合理利用物质的意识；能从物质及其变化的视角初步分析、解决一些与化学相关的简单的实际问题，发展辩证唯物主义世界观。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"};

MERGE (n:CourseTarget {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l2"})
SET n += {type: "CourseTarget", title: "发展科学思维，强化创新意识", description: "初步学会运用观察、实验、调查等手段获取化学事实，能初步运用比较、分类、分析、综合、归纳等方法认识物质及其变化，形成一定的证据推理能力；能从变化和联系的视角分析常见的化学现象，能以宏观、微观、符号相结合的方式认识和表征化学变化；初步建立物质及其变化的相关模型，能根据物质的类别和信息提示预测其性质，并能解释一些简单的化学问题；能从跨学科角度初步分析和解决简单的开放性问题，体会系统思维的意义；能对不同的观点和方案提出自己的见解，发展创新思维能力，逐步学会辩证唯物主义方法论。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l2"};

MERGE (n:CourseTarget {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l3"})
SET n += {type: "CourseTarget", title: "经历科学探究，增强实践能力", description: "认识实验是科学探究、创新实践的重要形式和学习化学的重要途径，能进行安全、规范的实验基本操作，独立或与同学合作完成简单的化学实验任务；能主动提出有探究价值的问题，从问题和假设出发确定探究目标，设计和实施探究方案，获取证据并分析得到结论，能用科学语言和信息技术手段合理表述探究的过程和结果，并与同学交流；能从化学视角对常见的生活现象、简单的跨学科问题进行探讨，能运用简单的技术与工程的方法初步解决与化学有关的实际问题，完成社会实践活动；在科学探究与实践活动中，能根据自己的实际情况制订学习计划，开展自主学习活动，能与同学合作、分享，善于听取他人的合理建议，评价、反思、改进学习过程与结果，初步形成自主、合作、探究的能力。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l3"};

MERGE (n:CourseTarget {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l4"})
SET n += {type: "CourseTarget", title: "养成科学态度，具有责任担当", description: "具有对物质世界及其变化的好奇心、探究欲和审美情趣；热爱科学，逐步形成崇尚科学、严谨求实、大胆质疑、追求真理、反对伪科学的科学精神及勇于克服困难的坚毅品质；学习科学家胸怀祖国、服务人民的爱国精神，勇攀高峰、敢为人先的创新精神，淡泊名利、潜心研究的奉献精神；认识创新在我国现代化建设全局中的核心地位，努力把科技自立自强信念自觉融入人生追求之中。赞赏化学对满足人民日益增长的美好生活需要和社会可持续发展作出的重大贡献；具有安全意识和合理选用化学品的观念；牢固树立和践行“绿水青山就是金山银山”的理念，强化绿色、循环、低碳发展的意识，认识资源的节约集约利用和废弃物循环利用的意义与价值，树立人与自然和谐共生的科学自然观；初步认识科学、技术、社会、环境之间的相互关系，遵守与化学、技术相关的伦理道德及法律法规，能积极参加与化学有关的社会热点问题的讨论并作出合理的价值判断，初步形成主动参与社会决策的意识；具有为全面建成社会主义现代化强国、实现中华民族伟大复兴而学习化学的志向和责任担当。", subject: "SB0402", applicableLevel: "OB03", contentJson: "{}", identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l4"};
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l2"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l3"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l3"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l4"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l4"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l2"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l3"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l3"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l4"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l4"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l5"})
MERGE (source)-[r:targetGuidesTheme]->(target)
SET r.label = "课程目标统领学习主题 / guidesTheme";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l5"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:course-target:l1"})
MERGE (source)-[r:themeAchievesTarget]->(target)
SET r.label = "学习主题达成课程目标 / achievesTarget";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l1"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l2"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l3"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l4"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l5"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l6"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l7"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l8"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l9"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l10"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l1"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l3"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l1"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l4"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:interdisciplinary-practice:l1"})
MERGE (source)-[r:literacyGuidesInterdisciplinaryPractice]->(target)
SET r.label = "核心素养引领跨学科实践 / guidesInterdisciplinaryPractice";
...
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l1"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l2"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l3"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l4"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l5"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l6"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l3"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l7"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l3"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l8"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l3"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l9"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l4"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l10"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l4"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l11"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:conception:l5"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-knowledge:l12"})
MERGE (source)-[r:conceptionStructuresCoreKnowledge]->(target)
SET r.label = "大概念统摄核心知识 / structuresCoreKnowledge";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l2"})
MERGE (source)-[r:themeCultivatesLiteracy]->(target)
SET r.label = "培育核心素养 / cultivatesLiteracy";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l3"})
MERGE (source)-[r:themeCultivatesLiteracy]->(target)
SET r.label = "培育核心素养 / cultivatesLiteracy";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:learning-theme:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l4"})
MERGE (source)-[r:themeCultivatesLiteracy]->(target)
SET r.label = "培育核心素养 / cultivatesLiteracy";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l1"})
MERGE (source)-[r:literacyGuidesQuality]->(target)
SET r.label = "指导学业质量 / guidesQuality";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MERGE (source)-[r:qualityEmbodiesLiteracy]->(target)
SET r.label = "体现核心素养 / embodiesLiteracy";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l2"})
MERGE (source)-[r:literacyGuidesQuality]->(target)
SET r.label = "指导学业质量 / guidesQuality";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MERGE (source)-[r:qualityEmbodiesLiteracy]->(target)
SET r.label = "体现核心素养 / embodiesLiteracy";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l4"})
MERGE (source)-[r:literacyGuidesQuality]->(target)
SET r.label = "指导学业质量 / guidesQuality";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l4"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l1"})
MERGE (source)-[r:qualityEmbodiesLiteracy]->(target)
SET r.label = "体现核心素养 / embodiesLiteracy";
...
MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l2"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l3"})
MERGE (source)-[r:literacyGuidesQuality]->(target)
SET r.label = "指导学业质量 / guidesQuality";

MATCH (source {identifier: "urn:jy:chemistry:SB0402:OB03:academic-quality:l3"})
MATCH (target {identifier: "urn:jy:chemistry:SB0402:OB03:core-literacy:l2"})
MERGE (source)-[r:qualityEmbodiesLiteracy]->(target)
SET r.label = "体现核心素养 / embodiesLiteracy";
